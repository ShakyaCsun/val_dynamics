...
class InteractiveViewer extends StatefulWidget {
  ...
  /// If `false` handle the transform of the child widget manually.
...
class _InteractiveViewerState extends State<InteractiveViewer>
  ...
  void _onScaleUpdate(ScaleUpdateDetails details) {
    ...
    final focalPointScene = _transformer.toScene(
    ...
    switch (_gestureType!) {
      case _GestureType.scale:
        ...
        // the scale.
        final focalPointSceneScaled = _transformer.toScene(
          details.localFocalPoint,
        );
        ...
        final focalPointSceneCheck = _transformer.toScene(
          details.localFocalPoint,
        );
  ...
  void _receivedPointerSignal(PointerSignalEvent event) {
    ...
    if (event is PointerScrollEvent) {
      if (event.kind == PointerDeviceKind.trackpad &&
        ...
        final newFocalPointScene = _transformer.toScene(
          local - localDelta,
        );
  ...
  void _handleScaleAnimation() {
    ...
    final referenceFocalPoint = _transformer.toScene(
