...
class $AssetsAgentsGen {
  const $AssetsAgentsGen();

  /// File path: assets/agents/abilities_map.txt
  String get abilitiesMap =>
      'packages/vsdat_ui/assets/agents/abilities_map.txt';

  /// Directory path: assets/agents/astra
  $AssetsAgentsAstraGen get astra => const $AssetsAgentsAstraGen();

  /// Directory path: assets/agents/breach
  $AssetsAgentsBreachGen get breach => const $AssetsAgentsBreachGen();

  /// Directory path: assets/agents/brimstone
  $AssetsAgentsBrimstoneGen get brimstone => const $AssetsAgentsBrimstoneGen();

  /// Directory path: assets/agents/chamber
  $AssetsAgentsChamberGen get chamber => const $AssetsAgentsChamberGen();

  /// Directory path: assets/agents/clove
  $AssetsAgentsCloveGen get clove => const $AssetsAgentsCloveGen();

  /// Directory path: assets/agents/cypher
  $AssetsAgentsCypherGen get cypher => const $AssetsAgentsCypherGen();

  /// Directory path: assets/agents/deadlock
  $AssetsAgentsDeadlockGen get deadlock => const $AssetsAgentsDeadlockGen();

  /// Directory path: assets/agents/fade
  $AssetsAgentsFadeGen get fade => const $AssetsAgentsFadeGen();

  /// Directory path: assets/agents/gekko
  $AssetsAgentsGekkoGen get gekko => const $AssetsAgentsGekkoGen();

  /// Directory path: assets/agents/harbor
  $AssetsAgentsHarborGen get harbor => const $AssetsAgentsHarborGen();

  /// Directory path: assets/agents/iso
  $AssetsAgentsIsoGen get iso => const $AssetsAgentsIsoGen();

  /// Directory path: assets/agents/jett
  $AssetsAgentsJettGen get jett => const $AssetsAgentsJettGen();

  /// Directory path: assets/agents/kayo
  $AssetsAgentsKayoGen get kayo => const $AssetsAgentsKayoGen();
  ...
  /// Directory path: assets/agents/omen
  $AssetsAgentsOmenGen get omen => const $AssetsAgentsOmenGen();

  /// Directory path: assets/agents/phoenix
  $AssetsAgentsPhoenixGen get phoenix => const $AssetsAgentsPhoenixGen();

  /// Directory path: assets/agents/raze
  $AssetsAgentsRazeGen get raze => const $AssetsAgentsRazeGen();

  /// Directory path: assets/agents/reyna
  $AssetsAgentsReynaGen get reyna => const $AssetsAgentsReynaGen();

  /// Directory path: assets/agents/sage
  $AssetsAgentsSageGen get sage => const $AssetsAgentsSageGen();

  /// Directory path: assets/agents/skye
  $AssetsAgentsSkyeGen get skye => const $AssetsAgentsSkyeGen();
...
class AssetGenImage {
  ...
  String get keyName => 'packages/vsdat_ui/$_assetName';
}
